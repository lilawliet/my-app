...
export const Projects: PROJECT[] = [
  ...
  },
  {
    ...
    name: '粤华优生活小程序',
    highlight: true,
    description: '基于北京万象生鲜系统二次开发，为珠海粤华搭建的线上销售平台，包含公园管养、爱尚卉、农科教育和农科优选模块',
    company: '珠海鲜美科技',
    resonsibility: '独立开发，各模块功能调试配置，项目多个版本业务功能迭代工作, 小程序嵌套的（公园管养/地图/推文）模块外部网站建设工作',
    tags: ['uni-app', 'vue3'],
    startTime: '2023-12',
    endTime: '2024-03',
  ...
  },
  {
    id: 'yuehua_home',
    name: '粤华园林官网',
    link: 'https://yhysh.xianmei01.com/',
    highlight: true,
    description: '为珠海粤华园林搭建的官网，主要功能包括公司介绍、服务项目、案例展示、新闻动态、联系我们等',
    company: '珠海鲜美科技',
  ...
  },
  {
    ...
    tags: ['react-native', 'react', 'redux-toolkit', 'typescript', 'docker', 'go', 'mongodb'],
    startTime: '2022-12',
    endTime: '2023-04',
    images: [
      '/bessage/gif/1.gif',
  ...
  },
  {
    ...
    tags: ['nextjs', 'react', 'redux-toolkit', 'typescript', 'graphql', 'mongodb'],
    startTime: '2022-02',
    endTime: '2022-02',
    images: [],
    position: 'self-end',
